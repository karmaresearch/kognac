...
#if defined(WIN32)
                    sprintf_s(tmpString, 1024, "%" PRId64 " %" PRId64 " %" PRId64, t.s, t.p, t.o);
#else
                    snprintf(tmpString, 1024, "%" PRId64 " %" PRId64 " %" PRId64, t.s, t.p, t.o);
#endif
                    out << tmpString << '\n';
                    countTriples++;
                }
...
#if defined(WIN32)
                    sprintf_s(tmpString, 1024, "%" PRId64 " %" PRId64 " %" PRId64, itr->s, itr->p, itr->o);
#else
                    snprintf(tmpString, 1024, "%" PRId64 " %" PRId64 " %" PRId64, itr->s, itr->p, itr->o);
#endif
                    out << tmpString << '\n';
                    countTriples++;
                }
